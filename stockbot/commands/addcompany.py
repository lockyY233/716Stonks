...
def setup_addcompany(tree: app_commands.CommandTree) -> None:
    ...
    @app_commands.describe(
        ...
        owner_user_ids="Owner Discord user IDs (comma-separated, use 0 for none). Owners cannot trade own stock.",
        ...
        slope="Base trend slope (% per tick). Recommended: -0.05 to +0.05.",
