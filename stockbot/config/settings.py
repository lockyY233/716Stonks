...
SLOT_BET_MIN = 5                           # Minimum /slot base bet per spin
SLOT_BET_MAX = 500                         # Maximum /slot base bet per spin before perks
SLOT_MAX_SPINS = 10                        # Maximum spins allowed per /slot command before perks
SLOT_HOURLY_SPIN_LIMIT = 50                # Base hourly /slot spin limit per player before perk modifiers
SLOT_PAIR_PAYOUT_BASE = 0.35               # Base payout multiplier (of effective bet) for a 2-of-a-kind result
SLOT_TRIPLE_MULT_CHERRY = 2.0              # 3x 🍒 payout multiplier (before perk win multiplier)
SLOT_TRIPLE_MULT_LEMON = 2.5               # 3x 🍋 payout multiplier (before perk win multiplier)
SLOT_TRIPLE_MULT_WATERMELON = 3.5          # 3x 🍉 payout multiplier (before perk win multiplier)
SLOT_TRIPLE_MULT_BELL = 5.0                # 3x 🔔 payout multiplier (before perk win multiplier)
SLOT_TRIPLE_MULT_STAR = 7.0                # 3x ⭐ payout multiplier (before perk win multiplier)
SLOT_TRIPLE_MULT_SEVEN = 12.0              # 3x 7️⃣ payout multiplier (before perk win multiplier)
SLOT_TRIPLE_MULT_DIAMOND = 25.0            # 3x 💎 payout multiplier (before perk win multiplier)
